<%@ Page Language="vb" AutoEventWireup="false" Codebehind="TeacherRemarks.aspx.vb" Inherits="Whiterose.TeacherRemarks"%>
	...
	<body>
		<form id="Form1" name="form1" method="post" runat="server">
			<table cellSpacing="0" cellPadding="0" width="746" align="center" border="0">
				...
				<tr>
					<td height="16" bgcolor="#feb429" align="left"><span class="style19">Tearcher Remarks 
							of
					...
					<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td width="76%" valign="top">
									<asp:DataGrid id=DataGrid1 runat="server" Width="744px" DataSource="<%# DsRemarks1 %>" DataMember="RemrksVW" AutoGenerateColumns="False" PageSize="20" AllowPaging="True">
										<ItemStyle Font-Size="X-Small"></ItemStyle>
										<HeaderStyle Font-Size="Small" Font-Names="Arial" Font-Bold="True" ForeColor="#FEB429" BackColor="White"></HeaderStyle>
										<Columns>
											<asp:BoundColumn DataField="RDate" SortExpression="RDate" HeaderText="Date">
												<HeaderStyle Width="15%"></HeaderStyle>
											</asp:BoundColumn>
											<asp:BoundColumn DataField="REMARKS" SortExpression="REMARKS" HeaderText="Remarks">
												<HeaderStyle Width="50%"></HeaderStyle>
											</asp:BoundColumn>
											<asp:BoundColumn DataField="TEACHERNAME" SortExpression="TEACHERNAME" HeaderText="Teacher Name">
