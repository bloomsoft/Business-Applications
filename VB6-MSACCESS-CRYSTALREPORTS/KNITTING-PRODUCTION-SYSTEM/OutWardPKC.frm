...
Begin VB.Form OutwardPKC 
   Caption         =   "Yarn Outward"
   ClientHeight    =   6165
   ClientLeft      =   60
   ClientTop       =   405
   ClientWidth     =   7095
   Icon            =   "OutWardPKC.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   6165
...
If Not tb.EOF Then
    ...
    Text20.Text = tb.Fields("vanno").Value & ""
   ...
   If tb.Fields("cont_no").Value > 0 Then
    ...
    edit1Cont .Rows - 1, tb.Fields("Cont_no").Value, 1
   End If
...
tb.AddNew
    ...
    tb.Fields("vanno").Value = Text20.Text
