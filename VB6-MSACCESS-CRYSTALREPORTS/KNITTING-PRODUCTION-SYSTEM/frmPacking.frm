...
Begin VB.Form frmPacking 
   ...
   Begin VB.Frame Frame1 
      ...
      Top             =   480
      Width           =   8655
      Begin VB.TextBox txtAccountOf1 
         DataField       =   "AccountOf"
         DataMember      =   "Command1"
      ...
      Begin VB.TextBox txtColor 
         ...
         Width           =   1050
      End
      Begin VB.TextBox txtTotalCarton 
         DataField       =   "ConDate"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
      ...
      Begin VB.Label lblFieldLabel 
         ...
         Left            =   600
         TabIndex        =   45
         ToolTipText     =   "Paking Description"
         Top             =   4605
         Width           =   840
      End
      Begin VB.Label lblFieldLabel 
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPacking.frx":0442
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPacking.frx":0986
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPacking.frx":0AE6
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPacking.frx":0BF2
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPacking.frx":0D52
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPacking.frx":0EB2
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPacking.frx":13F6
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPacking.frx":193A
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPacking.frx":1A9A
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPacking.frx":1C1E
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPacking.frx":1D7E
            Key             =   ""
         EndProperty
      EndProperty
   End
...
Sub OpenMasRecordSet()
    ...
    sSqlMas = "Select * from PakingMasTbl"
...
Sub OpenDetRecordSet()
    ...
    If rsDet.State = adStateOpen Then
        rsDet.Close
    End If
    sSqlDet = "Select * from PakingDetTbl"
...
Sub OpenEditRecordSet()
        ...
        If rsEdit.State = adStateOpen Then
            rsEdit.Close
        End If
    sqlTemp = "Select * from TempPakingTbl"
...
Sub FindRecord()
    ...
    End If
       ...
       rsMas.Open "Select * From PakingMasTbl", Cn, adOpenKeyset, adLockPessimistic
       If rsMas.RecordCount <> 0 Then
            ...
            rsMas.Find "InvNo ='" & sTemp & "'"
             ...
             'VisibleDet
                ...
                Else
                    FillMas
                    sSqlDet = "Select * from PakingDetTbl where InvNo ='" & Me.txtInvNo & "'"
...
Private Sub CmdUpdate_Click()
    If Me.txtGWeight.Text = "" Or Me.txtN_Weight.Text = "" Or Me.txtPcsQty.Text = "" Then
...
Private Sub edit_Click()
    ...
    While Not rsDet.EOF = True
     ...
     sEdit = "Select * from TempPakingTbl where InvNo = '" & Me.txtInvNo & "'"
...
Private Sub First_Click()
        ...
        End If
              rsMas.MoveFirst
              sSqlDet = "Select * from PakingDetTbl where InvNo ='" & rsMas.Fields(0) & "'"
              rsDet.Open sSqlDet, Cn, adOpenKeyset, adLockPessimistic
              EnableMas
              rsDetail = True
              FillMas
...
Sub FIllExisting()
    ...
    Me.txtShipFrom = "FAISALABAD"
    Me.txtShipedPer = "P.I.A"
...
Private Sub save_Click()
    ...
    If Me.txtInvNo.Text = "" Or Me.txtAccountOf.Text = "" Or Me.txtColor_Desc.Text = "" Then
        MsgBox "Incomplete Data to Save", vbInformation
        Me.txtInvNo.SetFocus
   Else
...
Public Sub SaveMasRecord()
    ...
    If mControl.Tag >= 0 And mControl.Tag <= 11 Then
...
Public Sub SaveDetRecord()
    ...
    Dim mControl As Control
    For Each mControl In Me.Controls
    If mControl.Tag >= 12 And mControl.Tag <= 20 Then
             rsDet.Fields(Val(mControl.Tag) - Val(11)) = mControl
        End If
    Next
    rsDet.Update
End Sub
...
'************************************************************
   Sub DeleteTemp()
    ...
    End If
        ...
        rsEdit.Open "Select * from TempPakingTbl", Cn, adOpenKeyset, adLockPessimistic
        rsEdit.MoveFirst
...
Public Sub ShowEdit()
    ...
    For Each mControl In Me.Controls
    If mControl.Tag >= 12 And mControl.Tag <= 20 Then
              If rsEdit.Fields(Val(mControl.Tag) - Val(11)) <> "" Then
                    mControl = rsEdit.Fields(Val(mControl.Tag) - Val(11))
              Else
                 mControl = " "
...
Public Sub SaveEdit()
    ...
    For Each mControl In Me.Controls
    If mControl.Tag >= 12 And mControl.Tag <= 20 Then
             rsEdit.Fields(Val(mControl.Tag) - Val(11)) = mControl
        End If
    Next
    rsEdit.Update
End Sub
...
Public Sub FillDet()
    ...
    If mControl.Tag >= 12 And mControl.Tag <= 20 Then
              ...
              mControl = rsDet.Fields(Val(mControl.Tag) - Val(11))
        Else
            mControl = " "
...
Private Sub txtAccountOf_KeyPress(KeyAscii As Integer)
    If KeyAscii = 13 Then
        Me.txtAccountOf1.SetFocus
    End If
    
End Sub


Private Sub txtAccountOf1_KeyPress(KeyAscii As Integer)
    If KeyAscii = 13 Then
        Me.txtShipFrom.SetFocus
    End If
End Sub
...
Private Sub txtCartonNo_KeyPress(KeyAscii As Integer)
    If KeyAscii = 13 Then
        Me.txtN_Weight.SetFocus
    End If
End Sub

Private Sub txtConDate_KeyPress(KeyAscii As Integer)
    If KeyAscii = 13 Then
       Me.txtTotalCarton.SetFocus
...
Private Sub txtLcNo_KeyPress(KeyAscii As Integer)
    If KeyAscii = 13 Then
        Me.txtShipedPer.SetFocus
    End If
End Sub

Private Sub txtPack_Desc_KeyPress(KeyAscii As Integer)
    If KeyAscii = 13 Then
        Me.txtColor_Desc.SetFocus
    End If
End Sub

Private Sub txtPcsQty_KeyPress(KeyAscii As Integer)
    If KeyAscii = 13 Then
        Me.txtSizeColor.SetFocus
    End If
End Sub


Private Sub txtN_Weight_KeyPress(KeyAscii As Integer)
    If KeyAscii = 13 Then
...
Private Sub txtShipedPer_KeyPress(KeyAscii As Integer)
    If KeyAscii = 13 Then
...
Private Sub txtShipFrom_KeyPress(KeyAscii As Integer)
    If KeyAscii = 13 Then
        Me.txtShiptTo.SetFocus
    End If
End Sub

Private Sub txtShiptTo_KeyPress(KeyAscii As Integer)
    If KeyAscii = 13 Then
        Me.txtLcNo.SetFocus
    End If
...
Private Sub txtSizeColor_KeyPress(KeyAscii As Integer)
    If KeyAscii = 13 Then
...
Private Sub txtTotalCarton_KeyPress(KeyAscii As Integer)
