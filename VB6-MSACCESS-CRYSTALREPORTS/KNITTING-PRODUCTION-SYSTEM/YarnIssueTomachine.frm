...
Begin VB.Form YarnIssueToMachine 
   Caption         =   "Yarn Issued to Machine for Knitting"
   ClientHeight    =   6165
   ClientLeft      =   60
   ClientTop       =   405
   ClientWidth     =   7095
   Icon            =   "YarnIssueTomachine.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   8595
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton Command3 
         ...
         Height          =   735
         Left            =   2280
         Picture         =   "YarnIssueTomachine.frx":030A
         Style           =   1  'Graphical
         TabIndex        =   49
         Top             =   240
         Width           =   1095
      ...
      Begin VB.CommandButton Command2 
         ...
         Height          =   735
         Left            =   1200
         Picture         =   "YarnIssueTomachine.frx":0614
         Style           =   1  'Graphical
         TabIndex        =   48
         Top             =   240
         Width           =   1095
      ...
      Begin VB.CommandButton Command1 
         ...
         Height          =   735
         Left            =   120
         Picture         =   "YarnIssueTomachine.frx":091E
         Style           =   1  'Graphical
         TabIndex        =   24
         Top             =   240
         Width           =   1095
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.OptionButton Option2 
         ...
         Height          =   735
         Left            =   1800
         Picture         =   "YarnIssueTomachine.frx":0C28
         Style           =   1  'Graphical
         TabIndex        =   46
         TabStop         =   0   'False
         Top             =   240
      ...
      Begin VB.OptionButton Option1 
         ...
         Height          =   735
         Left            =   240
         Picture         =   "YarnIssueTomachine.frx":0F32
         Style           =   1  'Graphical
         TabIndex        =   45
         TabStop         =   0   'False
         Top             =   240
   ...
   End
End
Attribute VB_Name = "YarnIssueToMachine"
...
With Grid1
    ...
    .TextMatrix(.Rows - 1, 14) = Text21.Text
    .TextMatrix(.Rows - 1, 15) = Text20.Text
    .TextMatrix(.Rows - 1, 16) = Text22.Text
...
With Grid1
    ...
    .ColWidth(14) = 1000
    .TextMatrix(0, 14) = "Machine #"
    .ColWidth(15) = 2000
    .TextMatrix(0, 15) = "Machine Name"
    .ColWidth(16) = 2000
    .TextMatrix(0, 16) = "Employee Name"
...
ssql = "select * from YarnIssue where in_no = " & c
ssql = ssql & " and E_type=2"
Set Tb = CN.Execute(ssql)
If Not Tb.EOF Then
    MsgBox "YarnIssue No already Exist..."
    Check = True
Else
    Check = False
End If
...
Private Function max1() As Double
    ...
    ssql = "select max(in_no)as c from YarnIssue where e_type=2"
    Set Tb = CN.Execute(ssql)
...
ssql = "select * from YarnIssue where in_no = " & Val(Text1.Text)
ssql = ssql & " and e_type=2"
...
If Not Tb.EOF Then
   ...
   End If
    ...
    .TextMatrix(.Rows - 1, 14) = Tb.Fields("MachineCode").Value & ""
    .TextMatrix(.Rows - 1, 15) = blm.machine(Tb.Fields("MachineCode").Value & "")
    .TextMatrix(.Rows - 1, 16) = Tb.Fields("Employee").Value & ""
...
If Option2 = True Then
    ssql = "delete from YarnIssue where in_no = " & Val(Text1.Text)
    ssql = ssql & " and e_type = 2"
    CN.Execute ssql
End If
Tb.Open "YarnIssue", CN, 0, 3, 0
...
Tb.AddNew
    ...
    Tb.Fields("MachineCode").Value = Val(.TextMatrix(i, 14))
    Tb.Fields("Employee").Value = .TextMatrix(i, 16)
    If Option2 = True Then
...
If R = vbYes Then
   Load vour
    vour.Caption = "Yarn Issue To Machines"
    vour.Text2.Text = 66
    vour.Text1.Text = Text1.Text
    vour.Label1.Caption = "YarnIssue #"
    vour.Show
End If
If R = vbNo Then
Command2_Click
...
If Grid1.Rows > 1 Then
    With Grid1
        ...
        Text21.Text = .TextMatrix(.Row, 14)
        Text20.Text = .TextMatrix(.Row, 15)
        Text22.Text = .TextMatrix(.Row, 16)
