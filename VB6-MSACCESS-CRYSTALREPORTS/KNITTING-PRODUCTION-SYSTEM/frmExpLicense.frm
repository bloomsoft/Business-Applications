...
Begin VB.Form frmExpLicense 
   Caption         =   "ALPHA kNITTING (pvt) Ltd..(Export License Form)"
   ClientHeight    =   3195
   ClientLeft      =   165
   ClientTop       =   735
   ClientWidth     =   4680
   Icon            =   "frmExpLicense.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   ScaleHeight     =   3195
   ScaleWidth      =   4680
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmExpLicense.frx":0442
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmExpLicense.frx":0986
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmExpLicense.frx":0AE6
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmExpLicense.frx":0BF2
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmExpLicense.frx":0D52
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmExpLicense.frx":0EB2
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmExpLicense.frx":13F6
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmExpLicense.frx":193A
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmExpLicense.frx":1A9A
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmExpLicense.frx":1C1E
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmExpLicense.frx":1D7E
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "frmExpLicense"
...
Sub OpenMasRecordSet()
    ...
    sSqlMas = "Select * from ExpLicMasTbl"
...
Sub OpenEditRecordSet()
    ...
    sqlTemp = "Select * from TempExpLicTbl"
...
Public Sub ShowEdit()
    ...
    If mControl.Tag >= 17 And mControl.Tag <= 21 Then
...
'************************************************************
  Sub DeleteTemp()
    ...
    End If
        ...
        rsEdit.Open "Select * from TempExpLicTbl", Cn, adOpenKeyset, adLockPessimistic
        rsEdit.MoveFirst
...
Private Sub edit_Click()
    ...
    While Not rsDet.EOF = True
     ...
     sEdit = "Select * from TempExpLicTbl where InvNo = '" & Me.txtInvNo & "'"
...
Sub OpenDetRecordSet()
    ...
    sSqlDet = "Select * from ExpLicDetTbl"
...
Sub FindRecord()
    ...
    End If
       ...
       rsMas.Open "Select * From ExpLicMasTbl", Cn, adOpenKeyset, adLockPessimistic
       If rsMas.RecordCount <> 0 Then
            ...
            rsMas.Find "InvNo ='" & sTemp & "'"
             ...
             'VisibleDet
                ...
                Else
                    FillMas
                    sSqlDet = "Select * from ExpLicDetTbl where InvNo ='" & Me.txtInvNo & "'"
...
Private Sub First_Click()
    On Error GoTo Errorhandler
        ...
        End If
              ...
              sSqlDet = "Select * from ExpLicDetTbl where InvNo ='" & rsMas.Fields(0) & "'"
              rsDet.Open sSqlDet, Cn, adOpenKeyset, adLockPessimistic
              EnableMas
              rsDetail = True
              FillMas
...
Private Sub save_Click()
    ...
    If Me.txtInvNo = "" Or Me.txtName = "" Or Me.txtCatNo = "" Or Me.txtConName = "" Or Me.txtDate = "" Then
        MsgBox "Incomplete Data to Save", vbInformation
        Me.txtInvNo.SetFocus
   Else
...
Private Sub txtOriginalNo_KeyPress(KeyAscii As Integer)
    If KeyAscii = 13 Then
        Me.txtQuotaYear.SetFocus
    End If
End Sub
