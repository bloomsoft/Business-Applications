...
If Val(Text1.Text) = 2 Then
    r1.ReportFileName = App.Path & "\City.Rpt"
    r1.DataFiles(0) = App.Path & "\Bloom.mdb"
    r1.WindowTop = 0
    r1.WindowLeft = 0
    r1.WindowState = crptMaximized
...
If Val(Text1.Text) = 3 Then
    r1.ReportFileName = App.Path & "\Chart.Rpt"
    f = "{Chart3.Code}=" & Combo1.ItemData(Combo1.ListIndex)
    r1.DataFiles(0) = App.Path & "\Bloom.mdb"
...
If Val(Text1.Text) = 4 Then
    r1.ReportFileName = App.Path & "\Groups.Rpt"
    r1.DataFiles(0) = App.Path & "\Bloom.mdb"
    r1.WindowTop = 0
    r1.WindowLeft = 0
    r1.WindowState = crptMaximized
...
If Val(Text1.Text) = 7 Then
    r1.ReportFileName = App.Path & "\WareHouse.Rpt"
    r1.DataFiles(0) = App.Path & "\Bloom.mdb"
    r1.WindowTop = 0
    r1.WindowLeft = 0
    r1.WindowState = crptMaximized
