...
Begin VB.Form SelectiveITHeads 
   BackColor       =   &H00FFFFFF&
   ...
   ClientTop       =   435
   ClientWidth     =   7155
   Icon            =   "SelectiveITHeads.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton Command5 
         ...
         Height          =   915
         Left            =   5220
         Picture         =   "SelectiveITHeads.frx":74F2
         Style           =   1  'Graphical
         TabIndex        =   13
         Top             =   210
         Width           =   1185
      ...
      Begin VB.CommandButton Command4 
         ...
         Height          =   915
         Left            =   3900
         Picture         =   "SelectiveITHeads.frx":77FC
         Style           =   1  'Graphical
         TabIndex        =   6
         Top             =   210
         Width           =   1275
      ...
      Begin VB.CommandButton Command3 
         ...
         Height          =   915
         Left            =   2670
         Picture         =   "SelectiveITHeads.frx":7C3E
         Style           =   1  'Graphical
         TabIndex        =   5
         Top             =   210
         Width           =   1185
      ...
      Begin VB.CommandButton Command2 
         ...
         Height          =   915
         Left            =   1530
         Picture         =   "SelectiveITHeads.frx":8908
         Style           =   1  'Graphical
         TabIndex        =   4
         Top             =   210
         Width           =   1095
      ...
      Begin VB.CommandButton Command1 
         ...
         Height          =   915
         Left            =   390
         Picture         =   "SelectiveITHeads.frx":95D2
         Style           =   1  'Graphical
         TabIndex        =   3
         Top             =   210
         Width           =   1095
   ...
   End
End
Attribute VB_Name = "SelectiveITHeads"
...
If Val(Text1.Text) = 1 Then
    ...
    r1.ReportFileName = App.path & "\StocksH.rpt"
    r1.DataFiles(0) = App.path & "\Book.mdb"
    r1.WindowTitle = "Closing Stocks of All Items in a Control Head"
    r1.Action = 1
End If
