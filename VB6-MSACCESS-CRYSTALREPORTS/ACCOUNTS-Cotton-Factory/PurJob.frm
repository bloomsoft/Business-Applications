...
Begin VB.Form PurJob 
   Caption         =   "Purchase Job Definition"
   ClientHeight    =   7575
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   11880
   Icon            =   "PurJob.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   7575
   ScaleWidth      =   11880
   ...
   Begin VB.Frame Frame6 
      ...
      Begin VB.ComboBox Combo3 
         Height          =   315
         ItemData        =   "PurJob.frx":27A2
         Left            =   90
         List            =   "PurJob.frx":27B5
         TabIndex        =   4
         Text            =   "Combo3"
         Top             =   420
         Width           =   2325
...
Private Function max1() As Double
    ...
    Ssql = "select max(v_no)as c from PurJob"
...
Set TB = DB.OpenRecordset("PurJob", dbOpenTable)
