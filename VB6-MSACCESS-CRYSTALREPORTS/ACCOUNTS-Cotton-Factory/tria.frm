...
Blmr.CostSheet Date2.Value, Date1.Value, p1
r1.ReportFileName = Blmr.report_path & "CostSheet.rpt"
r1.DataFiles(0) = App.path & "\Book.mdb"
r1.ReportTitle = Blm1.orgname
r1.WindowTop = 0
r1.WindowLeft = 0
...
Blmr.ClosingStocks Date2.Value, Date1.Value, p1
