...
Begin VB.Form SelectiveITSubHeads 
   BackColor       =   &H00FFFFFF&
   ...
   ClientTop       =   435
   ClientWidth     =   7155
   Icon            =   "SelectiveITSubHeads.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton Command1 
         ...
         Height          =   915
         Left            =   390
         Picture         =   "SelectiveITSubHeads.frx":74F2
         Style           =   1  'Graphical
         TabIndex        =   15
         Top             =   210
         Width           =   1095
      ...
      Begin VB.CommandButton Command2 
         ...
         Height          =   915
         Left            =   1530
         Picture         =   "SelectiveITSubHeads.frx":81BC
         Style           =   1  'Graphical
         TabIndex        =   14
         Top             =   210
         Width           =   1095
      ...
      Begin VB.CommandButton Command3 
         ...
         Height          =   915
         Left            =   2670
         Picture         =   "SelectiveITSubHeads.frx":8E86
         Style           =   1  'Graphical
         TabIndex        =   13
         Top             =   210
         Width           =   1185
      ...
      Begin VB.CommandButton Command4 
         ...
         Height          =   915
         Left            =   3900
         Picture         =   "SelectiveITSubHeads.frx":9B50
         Style           =   1  'Graphical
         TabIndex        =   12
         Top             =   210
         Width           =   1275
      ...
      Begin VB.CommandButton Command5 
         ...
         Height          =   915
         Left            =   5220
         Picture         =   "SelectiveITSubHeads.frx":9F92
         Style           =   1  'Graphical
         TabIndex        =   11
         Top             =   210
         Width           =   1185
   ...
   End
End
Attribute VB_Name = "SelectiveITSubHeads"
...
Ssql = "Select * from SubGroups"
If Combo1.ListIndex > -1 Then
    Ssql = Ssql & " where Mid(Code,1,2)='" & Combo1.ItemData(Combo1.ListIndex) & "'"
End If
...
Blmr.ClosingStocks DTPicker2.Value, DTPicker1.Value, ProgressBar1, , F
r1.ReportFileName = App.path & "\StocksSH.rpt"
r1.DataFiles(0) = App.path & "\Book.mdb"
r1.WindowTitle = "Closing Stocks of All Items in a Sub-Head"
r1.Action = 1
End If
