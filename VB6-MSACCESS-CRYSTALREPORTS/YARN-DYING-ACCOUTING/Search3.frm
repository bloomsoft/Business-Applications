...
YarnIssue.Text2.Text = Label1.Caption
YarnIssue.Text3.Text = Label2.Caption
Me.Hide
YarnIssue.Text2.SetFocus
End If

If Text3.Text = 2 Then
ClothRec.Text2.Text = Label1.Caption
ClothRec.Text3.Text = Label2.Caption
Me.Hide
ClothRec.Text2.SetFocus
End If

If Text3.Text = 3 Then
vouloompay.Text2.Text = Label1.Caption
vouloompay.Text3.Text = Label2.Caption
Me.Hide
vouloompay.Text2.SetFocus
End If

If Text3.Text = 5 Then
vour2.Text3.Text = Label1.Caption
vour2.Text4.Text = Label2.Caption
Me.Hide
vour2.Text3.SetFocus
End If
