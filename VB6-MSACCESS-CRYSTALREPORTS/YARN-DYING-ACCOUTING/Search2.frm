...
ClothRec.Text6.Text = Label1.Caption
ClothRec.Text7.Text = Label2.Caption
Me.Hide
ClothRec.Text6.SetFocus
End If

If Text3.Text = 2 Then
LotPacking.Text6.Text = Label1.Caption
LotPacking.Text7.Text = Label2.Caption
Me.Hide
LotPacking.Text6.SetFocus
End If

If Text3.Text = 3 Then
voudyingpay.Text6.Text = Label1.Caption
voudyingpay.Text7.Text = Label2.Caption
Me.Hide
voudyingpay.Text6.SetFocus
End If

If Text3.Text = 4 Then
vour4.Text3.Text = Label1.Caption
vour4.Text4.Text = Label2.Caption
Me.Hide
vour4.Text3.SetFocus
End If

If Text3.Text = 5 Then
vour5.Text3.Text = Label1.Caption
vour5.Text4.Text = Label2.Caption
Me.Hide
vour5.Text3.SetFocus
End If

If Text3.Text = 6 Then
frmLots.txtDyeCode.Text = Label1.Caption
frmLots.txtDyeName.Text = Label2.Caption
Me.Hide
frmLots.txtDyeCode.SetFocus
End If
